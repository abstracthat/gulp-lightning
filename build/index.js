...
(function() {
  module.exports = function(gulp, options) {
    var axis, bowerFiles, browserSync, browserify, bust, config, del, dirname, downbeat, exists, grid, jade, lib, map, marked, moment, plugins, reload, rsync, runSequence, rupture, through, typography, _;
    ...
    gulp.task('clean', ['clear'], function(done) {
      return del([config.development, config.production, './bower_components', 'site.json'], done());
    });
